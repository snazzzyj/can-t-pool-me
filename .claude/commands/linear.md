...
- `thoughts/rab/...` → `https://github.com/humanlayer/thoughts/blob/main/repos/humanlayer/rab/...`
...
3. **File reference formatting:**
   ...
   - Wrap paths in backticks: `thoughts/rab/example.md`
...
- rab: b157f9e4-8faf-4e7e-a598-dae6dec8a584
- joel: ########-####-####-############
